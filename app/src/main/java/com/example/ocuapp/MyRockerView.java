...
//                mOnDistanceLevelListener.onDistanceShow(mCenterPoint.x,mCenterPoint.y,mRockerPosition.x,mRockerPosition.y);
            }
        }
        if (null != mOnAngleChangeListener) {
    ...
    private void callBackFinish() {
        ...
        if (null != mOnAngleChangeListener) {
            int xpos=0;
            int ypos=0;
            mOnAngleChangeListener.onFinish(xpos,ypos);
        }
        if (null != mOnShakeListener) {
    ...
    public interface OnAngleChangeListener {
        ...
        void onDistanceShow(int xpos,int ypos);

        // 结束
        void onFinish(int xpos,int ypos);
    }
